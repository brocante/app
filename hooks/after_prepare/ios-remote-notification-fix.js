...
console.log('');
console.log('# ================================================================');
console.log('# HOOK: ios-remote-notification-fix.js');
console.log('# ================================================================');

// The file to change (and its backup).
var fn = 'platforms/ios/Brocante/Classes/AppDelegate.m';
...
if (fs.existsSync(fn) && !fs.existsSync(fno)) {
    ...
    fs.readFile(fn, function(err, data) {
        ...
        for(var i=0; i<lines.length; i++) {
            ...
            //
            var found = false;
            var needToEndif = false;
            for(var j=0; j<fcts.length; j++) {
                if (line.indexOf(fcts[j]) >=0 ) {
                    found = true;
                    needToEndif = needToEndif || found && j === 0;
                    break
                }
            }
...
console.log('# ================================================================');
console.log('# DONE: ios-remote-notification-fix.js');
console.log('# ================================================================');